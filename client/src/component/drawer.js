...
export default function SwipeableTemporaryDrawer() {
  ...
  const handleClick=async(event)=>{
    ...
    await axios.get("https://madstuffs-backend.onrender.com/logout",{
      withCredentials:true
    }).then(()=>{
      setLogged(false)
    })
  ...
  const list = (anchor) => (
    ...
    >
      ...
      <CardHeader
        ...
        title={isLoading ? "Loading..." :logged? author : "Login to Continue..."}
        sx={{ backgroundColor: 'black', color: 'white',height:10,paddingTop:4}} 
      />
      ...
      <List>
        ...
        {logged?
        <div>
          <NavLink to={"/editpage"} style={{textDecoration:"none"}}><ListItem disablePadding>
            <ListItemButton >
              <ListItemIcon>
                <ContactMailIcon style={list_style}/>
              </ListItemIcon>
              <ListItemText primary='Edit My Page' sx={{color:"black"}}/>
            </ListItemButton>
          </ListItem>
          </NavLink>
          </div>:
      ...
      <List>
        ...
        <div>
          ...
          <ListItemButton>
           ...
           :
           <NavLink onClick={handleClick} style={{textDecoration:"none"}}><ListItem disablePadding>
          <ListItemButton>
              <ListItemIcon>
                <InfoIcon style={list_style}/>
              </ListItemIcon>
